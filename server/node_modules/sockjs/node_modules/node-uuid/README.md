...
* [Annotated source code](https://broofa.github.com/node-uuid/docs/uuid.html)
...
For browser performance [checkout the JSPerf tests](https://jsperf.com/node-uuid-performance).
