 ...
 * https://idea.popcount.org/ and https://sockjs.popcnt.org/ (hosted in Europe)
 * https://sockjs.cloudfoundry.com/ (CloudFoundry, websockets disabled, loadbalanced)
...
[Streams API](https://nodejs.org/docs/v0.5.8/api/streams.html) or
...
[HAProxy](https://www.haproxy.org/) are able to proxy WebSocket
